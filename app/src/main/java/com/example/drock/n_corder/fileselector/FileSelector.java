...
/**
 * Create the file selection dialog_file_selector. This class will create a custom dialog_file_selector for
...
public class FileSelector {
	...
	/** Cancel Button - close dialog_file_selector */
	...
	/**
	 * The file selector dialog_file_selector.
	 */
	...
	/**
	 * Constructor that creates the file selector dialog_file_selector.
	 * 
	 * @param context
	 *            The current context.
	 * @param operation
	...
	private void prepareFilterSpinner(String[] filesFilter) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(mContext, R.layout.spinner_item, filesFilter);
	...
	/** Opens a dialog_file_selector for creating a new folder. */
	...
	public FileSelector setDefaultFileName(String fileName) {
